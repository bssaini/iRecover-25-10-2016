...
{
    public class NewWitnessViewModel : NewItemViewModel
    {

        private ICommand mSaveCommand;

        private MobileServiceClient client;
        private IMobileServiceTable<AccidentWitnessInfoData> infoTable;
        ...
        public NewWitnessViewModel()
        {
            ...
            try
            {
                ...
                infoTable = client.GetTable<AccidentWitnessInfoData>();
        ...
        public async void SaveInfoToServer()
        {
            ...
            var item = new AccidentWitnessInfoData
            {
                name = Name,
